...
class CamShiftDemo:
    ...
    def __init__(self):
        ...
        cv.SetMouseCallback( "CamShiftDemo", self.on_mouse) #Instantiate call back for mouse event
    ...
    def hue_histogram_as_image(self, hist):
        ...
        cv.Log(mybins, mybins) #Calculate logarithm of all values (so there are all above 0)
        
        (_, hi, _, _) = cv.MinMaxLoc(mybins)
        cv.ConvertScale(mybins, mybins, 255. / hi) #Rescale all element to get the highest at 255
        ...
        histimg = cv.CreateImage( (320,200), 8, 3) #Convert image from hsv to RGB
    ...
    def run(self):
        ...
        while True:
            ...
            if self.track_window and is_rect_nonzero(self.track_window):
                ...
                (iters, (area, value, rect), track_box) = cv.CamShift(backproject, self.track_window, crit) #Call the camshift !!
